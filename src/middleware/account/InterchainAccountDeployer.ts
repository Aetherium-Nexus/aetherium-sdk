...
import { Router } from "@aetherium-nexus/core";
import { assert } from "@aetherium-nexus/utils";
...
> {
  ...
  router(contracts: AetheriumContracts<InterchainAccountFactories>): Router {
  ...
  ): Promise<AetheriumContracts<InterchainAccountFactories>> {
    if (config.interchainSecurityModule) {
