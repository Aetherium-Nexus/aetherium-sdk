...
import { InterchainAccountRouter } from "@aetherium-nexus/core";
import {
  Address,
  addBufferToGasLimit,
  addressToBytes32,
...
export class InterchainAccount extends RouterApp<InterchainAccountFactories> {
  constructor(
    contractsMap: AetheriumContractsMap<InterchainAccountFactories>,
  ...
  router(
    contracts: AetheriumContracts<InterchainAccountFactories>
...
export function buildInterchainAccountApp(
  ...
  const addressesMap: AetheriumAddressesMap<any> = {
