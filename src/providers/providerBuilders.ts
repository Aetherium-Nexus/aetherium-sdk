...
import { ProtocolType, isNumeric } from "@aetherium-nexus/utils";
...
import { AetheriumSmartProvider } from "./SmartProvider/SmartProvider.js";
...
export function defaultEthersV5ProviderBuilder(
  ...
  const provider = new AetheriumSmartProvider(
    network,
    rpcUrls,
    undefined,
