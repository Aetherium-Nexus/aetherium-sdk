...
import { Ownable__factory } from "@aetherium-nexus/core";
import { assert, eqAddress, rootLogger } from "@aetherium-nexus/utils";
...
export class AetheriumCoreChecker extends AetheriumAppChecker<
  AetheriumCore,
  CoreConfig
> {
  constructor(
