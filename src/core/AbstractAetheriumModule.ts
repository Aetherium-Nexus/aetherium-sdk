...
import { Annotated, ProtocolType } from "@aetherium-nexus/utils";

import { ProtocolTypedTransaction } from "../providers/ProviderType.js";
import { ChainNameOrId } from "../types.js";

export type AetheriumModuleParams<
  TConfig,
...
export abstract class AetheriumModule<
...
> {
  ...
  protected constructor(
    protected readonly args: AetheriumModuleParams<TConfig, TAddressMap>
  ) {}
