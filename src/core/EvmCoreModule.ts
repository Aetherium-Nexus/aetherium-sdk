...
} from "./AbstractAetheriumModule.js";
...
export class EvmCoreModule extends AetheriumModule<
...
> {
  ...
  constructor(
    ...
    args: AetheriumModuleParams<CoreConfig, DeployedCoreAddresses>
  ) {
    super(args);
  ...
  /**
   * Deploys the core Aetherium contracts.
  ...
  static async deploy(params: {
    ...
    const ismFactory = new AetheriumIsmFactory(
      attachContractsMap(
    ...
    const coreDeployer = new AetheriumCoreDeployer(
      multiProvider,
      ismFactory,
      contractVerifier
    );
    ...
    const serializedContracts = serializeContractsMap(
      coreDeployer.deployedContracts as AetheriumContractsMap<
  ...
  static async deployIsmFactories(params: {
    ...
    multiProvider: MultiProvider;
    contractVerifier?: ContractVerifier;
  }): Promise<AetheriumAddresses<ProxyFactoryFactories>> {
  ...
  static async deployMailbox(params: {
    config: CoreConfig;
    proxyAdmin: Address;
    coreDeployer: AetheriumCoreDeployer;
    multiProvider: MultiProvider;
    chain: ChainNameOrId;
  }): Promise<Mailbox> {
    const {
