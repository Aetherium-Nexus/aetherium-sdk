import { TestRecipient, TestRecipient__factory } from "@aetherium-nexus/core";
import { Address, rootLogger } from "@aetherium-nexus/utils";
...
export class TestRecipientDeployer extends AetheriumDeployer<
  TestRecipientConfig,
