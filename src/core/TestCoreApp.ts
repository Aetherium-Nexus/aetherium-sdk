...
import { TestMailbox, TestMailbox__factory } from "@aetherium-nexus/core";
import { messageId } from "@aetherium-nexus/utils";
...
export class TestCoreApp extends AetheriumCore {
  getContracts(chain: ChainName): AetheriumContracts<typeof testCoreFactories> {
    return super.getContracts(chain) as AetheriumContracts<
