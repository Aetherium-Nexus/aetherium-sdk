...
export class AetheriumRelayer {
  ...
  async relayAll(
    ...
    messages = AetheriumCore.getDispatchedMessages(dispatchTx)
  ...
  async relayMessage(
    dispatchTx: providers.TransactionReceipt,
    messageIndex = 0,
    message = AetheriumCore.getDispatchedMessages(dispatchTx)[messageIndex]
