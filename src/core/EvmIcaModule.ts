...
import { InterchainAccountRouter__factory } from "@aetherium-nexus/core";
import {
  Domain,
  EvmChainId,
  ProtocolType,
...
export class EvmIcaModule extends AetheriumModule<
  ProtocolType.Ethereum,
  InterchainAccountConfig,
  AetheriumAddresses<InterchainAccountFactories>
> {
