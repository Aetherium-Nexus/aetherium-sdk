...
import { AetheriumIgpDeployer } from "../gas/AetheriumIgpDeployer.js";
...
export class AetheriumHookDeployer extends AetheriumDeployer<
  HookConfig,
  HookFactories
> {
  constructor(
    ...
    readonly igpDeployer = new AetheriumIgpDeployer(
      multiProvider,
      contractVerifier,
      concurrentDeploy
    )
  ...
  ): Promise<AetheriumContracts<HookFactories>> {
  ...
  async deployIgp(
    ...
    coreAddresses = this.core[chain]
  ): Promise<AetheriumContracts<IgpFactories>> {
