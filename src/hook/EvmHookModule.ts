...
import { AetheriumDeployer } from "../deploy/AetheriumDeployer.js";
...
class HookDeployer extends AetheriumDeployer<{}, HookFactories> {
...
export class EvmHookModule extends AetheriumModule<
  ProtocolType.Ethereum,
  HookConfig,
  AetheriumAddresses<ProxyFactoryFactories> & HookModuleAddresses
> {
  ...
  protected readonly hookFactory: AetheriumIsmFactory;
  ...
  constructor(
    ...
    this.hookFactory = AetheriumIsmFactory.fromAddressesMap(
