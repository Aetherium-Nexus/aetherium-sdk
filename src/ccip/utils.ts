...
import { CCIPHook, CCIPIsm } from "@aetherium-nexus/core";

import { AetheriumAddressesMap } from "../contracts/types.js";
...
export class CCIPContractCache {
  private cachedAddresses: AetheriumAddressesMap<any> = {};

  constructor(addressesMap?: AetheriumAddressesMap<any>) {
    if (addressesMap) {
  ...
  getAddressesMap(): AetheriumAddressesMap<any> {
    return this.cachedAddresses;
  }

  writeBack(cachedAddresses: AetheriumAddressesMap<any>): void {
