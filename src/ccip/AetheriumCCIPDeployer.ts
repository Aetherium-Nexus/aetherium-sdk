import { CCIPHook__factory, CCIPIsm__factory } from "@aetherium-nexus/core";
import {
  ZERO_ADDRESS_HEX_32,
  addressToBytes32,
  assert,
...
export class AetheriumCCIPDeployer extends AetheriumDeployer<
  Set<ChainName>,
  {}
> {
  ...
  constructor(
    ...
    super(
      ...
      {},
      {
        logger: rootLogger.child({ module: "AetheriumCCIPDeployer" }),
        contractVerifier,
      }
    );
  }
