 ...
 * ANY CHANGES HERE NEED TO BE REFLECTED IN AETHERIUM-BASE CONFIG PARSING.
 */
import { SafeParseReturnType, z } from "zod";

import { ProtocolType, objMerge } from "@aetherium-nexus/utils";
...
/**
 * A collection of useful properties and settings for chains using Aetherium Nexus Protocol
...
export const ChainMetadataSchemaObject = z.object({
  ...
  deployer: z
    ...
    .optional()
    .describe(
      "Identity information of the deployer of a Aetherium instance to this chain"
    ),
