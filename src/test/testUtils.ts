...
import { Address, exclude, objMap } from '@aetherium-nexus/utils';
...
export function createRouterConfigMap(
  owner: Address,
  coreContracts: AetheriumContractsMap<CoreFactories>,
  igpContracts: AetheriumContractsMap<IgpFactories>,
