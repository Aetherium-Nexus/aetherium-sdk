...
import { AetheriumSmartProvider } from "../providers/SmartProvider/SmartProvider.js";
import { ChainNameOrId } from "../types.js";

export class AetheriumReader {
  ...
  protected setSmartProviderLogLevel(level: LevelWithSilentOrString): void {
    if ("setLogLevel" in this.provider) {
      (this.provider as AetheriumSmartProvider).setLogLevel(level);
    }
  }
}
