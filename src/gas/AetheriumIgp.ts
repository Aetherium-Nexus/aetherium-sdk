...
import { InterchainGasPaymaster__factory } from "@aetherium-nexus/core";
...
export class AetheriumIgp extends AetheriumApp<IgpFactories> {
  static fromAddressesMap(
    ...
    return new AetheriumIgp(helper.contractsMap, helper.multiProvider);
  }
