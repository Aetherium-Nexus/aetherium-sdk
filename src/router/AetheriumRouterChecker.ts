...
import { AetheriumFactories } from "../contracts/types.js";
import { AetheriumAppChecker } from "../deploy/AetheriumAppChecker.js";
...
export class AetheriumRouterChecker<
  Factories extends AetheriumFactories,
  App extends RouterApp<Factories>,
  Config extends RouterConfig
> extends AetheriumAppChecker<App, Config> {
  constructor(
    multiProvider: MultiProvider,
    app: App,
    configMap: ChainMap<Config>,
    readonly ismFactory?: AetheriumIsmFactory,
    readonly logger = rootLogger.child({ module: "AetheriumRouterChecker" })
  ) {
