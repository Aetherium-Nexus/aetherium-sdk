import { Ownable, Router } from "@aetherium-nexus/core";
import {
  Address,
  addBufferToGasLimit,
  addressToBytes32,
...
export abstract class AetheriumRouterDeployer<
  Config extends RouterConfig,
  Factories extends AetheriumFactories
> extends AetheriumDeployer<Config, Factories> {
  ...
  async enrollRemoteRouters(
    deployedContractsMap: AetheriumContractsMap<Factories>,
    _: ChainMap<Config>,
