...
import { Address, ProtocolType } from "@aetherium-nexus/utils";
...
const STANDARD_TO_TOKEN: Record<TokenStandard, TokenArgs | null> = {
  ...
  [TokenStandard.EvmAetNative]: {
    ...
    standard: TokenStandard.EvmAetNative,
  ...
  [TokenStandard.EvmAetCollateralFiat]: {
    chainName: TestChainName.test3,
    standard: TokenStandard.EvmAetCollateralFiat,
    addressOrDenom: "0x31b5234A896FbC4b3e2F7237592D054716762131",
    collateralAddressOrDenom: "0x64544969ed7ebf5f083679233325356ebe738930",
    decimals: 18,
    symbol: "USDC",
  ...
  [TokenStandard.SealevelAetNative]: {
    chainName: testSealevelChain.name,
    standard: TokenStandard.SealevelAetNative,
  ...
  [TokenStandard.SealevelAetCollateral]: {
    chainName: testSealevelChain.name,
    standard: TokenStandard.SealevelAetCollateral,
  ...
  [TokenStandard.SealevelAetSynthetic]: {
    chainName: testSealevelChain.name,
    standard: TokenStandard.SealevelAetSynthetic,
  ...
  [TokenStandard.CwAetNative]: {
    chainName: testCosmosChain.name,
    standard: TokenStandard.CwAetNative,
  ...
  [TokenStandard.CwAetCollateral]: {
    chainName: testCosmosChain.name,
    standard: TokenStandard.CwAetCollateral,
    addressOrDenom:
  ...
  [TokenStandard.CwAetSynthetic]: null,

  //TODO: check this and manage it.
  [TokenStandard.StarknetAetCollateral]: null,
  [TokenStandard.StarknetAetNative]: null,
  [TokenStandard.StarknetAetSynthetic]: null,
};
...
> = {
  ...
  [TokenStandard.CwAetNative]: "inj1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3lj7tt0",
};
