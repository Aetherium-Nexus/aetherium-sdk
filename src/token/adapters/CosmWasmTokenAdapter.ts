...
export class CwAetSyntheticAdapter
  extends CwTokenAdapter
  implements IAetTokenAdapter<ExecuteInstruction>
{
  constructor(
...
export class CwAetNativeAdapter
  extends CwNativeTokenAdapter
  implements IAetTokenAdapter<ExecuteInstruction>
{
  private readonly cw20adapter: CwAetSyntheticAdapter;
  ...
  constructor(
    ...
    super(chainName, multiProvider, addresses, "");
    this.cw20adapter = new CwAetSyntheticAdapter(chainName, multiProvider, {
      token: "",
...
export class CwAetCollateralAdapter
  extends CwAetNativeAdapter
  implements IAetTokenAdapter<ExecuteInstruction>
{
  constructor(
    public readonly chainName: ChainName,
