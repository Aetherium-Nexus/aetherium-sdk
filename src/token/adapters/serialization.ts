...
import { Domain } from "@aetherium-nexus/utils";
...
/**
 * Aetherium Token Borsh Schema
 */
export class SealevelAetheriumTokenData {
...
export const SealevelAetheriumTokenDataSchema = new Map<any, any>([
  [
    SealevelAccountDataWrapper,
    getSealevelAccountDataSchema(SealevelAetheriumTokenData),
  ],
  [
...
export enum SealevelAetTokenInstruction {
  Init,
  TransferRemote,
  EnrollRemoteRouter,
  EnrollRemoteRouters,
