...
import { Address, Domain, assert } from "@aetherium-nexus/utils";
...
import { CwAetCollateralAdapter } from "./CosmWasmTokenAdapter.js";
import {
  IAetTokenAdapter,
  ITokenAdapter,
  InterchainGasQuote,
...
// This implements the IAetTokenAdapter interface but it's an imperfect fit as some
...
export class CosmIbcTokenAdapter
  ...
  implements IAetTokenAdapter<MsgTransferEncodeObject>
{
  constructor(
    public readonly chainName: ChainName,
    public readonly multiProvider: MultiProtocolProvider,
  ...
  implements IAetTokenAdapter<MsgTransferEncodeObject>
{
  ...
  async populateTransferRemoteTx(
    ...
    const cwAdapter = new CwAetCollateralAdapter(
