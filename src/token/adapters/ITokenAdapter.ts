import { Address, Domain, Numberish } from "@aetherium-nexus/utils";
...
export interface IAetTokenAdapter<Tx> extends ITokenAdapter<Tx> {
...
export interface IAetXERC20Adapter<Tx> extends IAetTokenAdapter<Tx> {
...
export interface IAetVSXERC20Adapter<Tx> {
