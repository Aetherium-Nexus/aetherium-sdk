...
import { AetheriumCore } from "../../core/AetheriumCore.js";
...
import { randomIsmConfig } from "../AetheriumIsmFactory.hardhat-test.js";
...
describe("BaseMetadataBuilder", () => {
  ...
  let proxyFactoryAddresses: AetheriumAddresses<ProxyFactoryFactories>;
  ...
  before(async () => {
    ...
    for (const chain of Object.keys(hookConfig)) {
      ...
      ) as AetheriumAddresses<ProxyFactoryFactories>;
