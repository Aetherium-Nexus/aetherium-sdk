...
class IsmDeployer extends AetheriumDeployer<{}, typeof ismFactories> {
...
export class AetheriumIsmFactory extends AetheriumApp<ProxyFactoryFactories> {
  ...
  constructor(
    contractsMap: AetheriumContractsMap<ProxyFactoryFactories>,
  ...
  static fromAddressesMap(
    ...
    return new AetheriumIsmFactory(
      helper.contractsMap,
      multiProvider,
      ccipContractCache
    );
