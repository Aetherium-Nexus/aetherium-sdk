...
import { DomainRoutingIsm__factory } from "@aetherium-nexus/core";
import {
  Address,
  Domain,
  EvmChainId,
...
export class EvmIsmModule extends AetheriumModule<
  ProtocolType.Ethereum,
  IsmConfig,
  AetheriumAddresses<ProxyFactoryFactories> & IsmModuleAddresses
> {
  protected readonly logger = rootLogger.child({ module: "EvmIsmModule" });
  protected readonly reader: EvmIsmReader;
  protected readonly ismFactory: AetheriumIsmFactory;
  ...
  constructor(
    ...
    this.ismFactory = AetheriumIsmFactory.fromAddressesMap(
